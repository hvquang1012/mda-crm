...
const SHELL = [
  ...
  ...['dashboard', 'approve', 'tasks', 'chat', 'alert', 'report', 'history', 'role-kts', 'role-manager', 'role-admin', 'client-link', 'dependencies', 'members', 'close-project', 'reopen-project'].map(n => `./assets/icons/${n}.svg`)
];
